...
RANGE_TABLE_PREFIX = 'part'
RROBIN_TABLE_PREFIX = 'table'
...
import TestingConnection as MyAssignment  # TODO: Change the 'Assignment' to your filename
...
def getopenconnection(user='postgres', password='cse512dds', dbname='postgres'):
